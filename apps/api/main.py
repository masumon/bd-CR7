...
def create_app() -> Any:
    ...
    from modules.contractor.router import router as contractor_router
    from modules.dynamic.router import router as dynamic_router
    ...
    app.include_router(contractor_router, prefix="/api/contractor", tags=["contractor"])
    app.include_router(dynamic_router, prefix="/api/dynamic", tags=["dynamic"])
